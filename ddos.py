...
def usage():
    ...
    print "Example ./ddos.py -t 192.168.1.100 -r 256\n"
...
if __name__ == "__main__":
    print "\n#Heloo Welcome  ^_^ "
    print " #"+term.RED + " Welcome To Hacking With DDOS "+term.NORMAL
    print " DDOS  Using Tor "
    print " Contact email : ad.android@yahoo.com"
    print " Contact Facebook : www.facebook.com/my.profile.co.id"
    print " #Created By X-Mr.R4h1m#"
    print " Hapy Hacking ^_^\n"
